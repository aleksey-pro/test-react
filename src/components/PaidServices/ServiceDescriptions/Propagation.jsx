...
const Propagation = ({ sId = 'propagation' }) => {
    ...
    const handleAddBlock = () => {
        dispatch({
            ...
            payload: { id: sId, title: "Підняття", price: count * 10 },
        });
    }
    return <div className="service_items__discription">
        ...
        <div className="discription_text">
            <div className="text">
                Поднятие — в результатах поиска объявление показывается выше объявлений, для которых поднятие не включено.
